...
boc.pfx.particleFactories.SmokeStarFactory = function (entityManager, max) {
    ...
    var _subImage = boc.resources.GraphicsManager.getImage('assets/graphics/pfx_smoke_small.png');
